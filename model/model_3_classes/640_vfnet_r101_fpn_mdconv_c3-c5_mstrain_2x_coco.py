...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '/content/drive/MyDrive/data_3_classes/size_640/annotations/train_annotations_coco.json',
    ...
    val=dict(
        type='CocoDataset',
        ann_file=
        '/content/drive/MyDrive/data_3_classes/size_640/annotations/val_annotations_coco.json',
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                entity='thesisltran',
                name='VarifocalNet_3_640',
                id='VarifocalNet_3_640',
                notes='vfnet_r101_fpn_mdconv_c3-c5_mstrain_2x_coco',
                save_code=True,
                tags=["3", "640", "VarifocalNet"]
            ),
            interval=10,
            log_checkpoint=True,
