...
def get_swin_mask_rcnn_config(
    ...
    cfg = Config.fromfile('/content/mmdetection/configs/swin/mask_rcnn_swin-t-p4-w7_fpn_1x_coco.py')
    ...
    cfg.log_config.hooks = [
        ...
        dict(type='MMDetWandbHook',
             init_kwargs={'project': 'Cancer_Detection',
                          'name': 'Swin_Mask_RCNN_' + str(num_classes) + "_" + str(img_size) + "_" + str(pretrained),
                          'id': 'Swin_Mask_RCNN_' + str(num_classes) + "_" + str(img_size) + "_" + str(pretrained),
                          'save_code': True,
                          'tags': [str(num_classes), str(img_size), "Swin_Mask_RCNN", str(pretrained)]
                          },
             interval=10,
             log_checkpoint=True,
